<?php
	...
	$table = "<tr><th>Created</th><th>Day(s)</th><th>Start Time</th><th>End Time</th><th>Turn On/Off</th><th>Mode</th><th>Target Temp</th><th>Fan Level</th><th>Swing</th><th>Hor. Swing</th><th>Enabled</th><th>Edit</th><th>Delete</th></tr>";
	...
	while($drow = mysqli_fetch_assoc($res))
	{
		...
		$table .= substr($drow['startTime'],0,5)."', '".substr($drow['endTime'],0,5)."', '".$drow['turnOnOff']."', '".$drow['mode']."', '".$drow['targetTemperature']."', '";
		$table .= $drow['fanLevel']."', '".$drow['swing']."', '".$drow['horizontalSwing']."', '".$drow['enabled']."'";
